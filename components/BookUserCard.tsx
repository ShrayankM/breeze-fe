  ...
  return (
    <TouchableOpacity onPress={onPress} style={styles.card}>
      <View style={styles.thumbnailContainer}>
        <Image source={{ uri: thumbnail }} resizeMode="contain" style={styles.thumbnail} />
      </View>
      ...
      <View style={styles.infoContainer}>
        ...
        <View style={styles.rowContainer}>
          ...
          {/* Status card with fixed width and flexible content */}
...
const styles = StyleSheet.create({
  ...
  rowContainer: {
    flexDirection: 'row',
    justifyContent: 'space-between', // Ensure the space between items is distributed properly
    alignItems: 'center',
    marginTop: 4,
  },
